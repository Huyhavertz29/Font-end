  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '20px' }}>
        <TableComponent handleDeleteMany={handleDeleteManyUsers} columns={columns} isLoading={isPendingUsers} data={dataTable} onRow={(record, rowIndex) => {
          return {
            onClick: event => {
      ...
      <DrawerComponent title='Chi tiết ' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width="90%">
