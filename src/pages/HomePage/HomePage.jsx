...
const HomePage = () => {
  ...
  // const {isPending, data: products} = useQuery(['getAllProduct'],fetchProductAll,{retry: 3,retryDelay: 1000 })
      ...
      <div className='body' style={{ width: '100%', backgroundColor: '#efefef' }}>
        <div id="container" style={{ height: '1000px', width: '1270px', margin: '0 auto' }}>
          ...
          <div style={{ width: '100%', display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
            <WrapperButtonMore textbutton={isPreviousData ? 'Tải thêm' : "Xem thêm"} type="outline" styleButton={{
