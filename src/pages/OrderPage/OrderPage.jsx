...
import { WrapperCountOrder, WrapperInfo, WrapperItemOrder, WrapperLeft, WrapperListOrder, WrapperPriceDiscount, WrapperRight, WrapperStyleHeader, WrapperStyleHeaderDilivery, WrapperTotal } from "./style.js";
...
import Step from "../../components/StepComponent/StepComponent.jsx";
...
const OrderPage = () => {
    ...
    const itemsDelivery = [
        ...
        {
            title: '15.000 VND',
            description: 'Từ 2.000.000 đến dưới 5.000.000 VND',
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <WrapperLeft>
                        <WrapperStyleHeaderDilivery>
                            <Step items={itemsDelivery} current={deliveryPriceMemo === 15000
                                ? 1 : deliveryPriceMemo === 50000 ? 0
                                    ...
                                    <WrapperItemOrder key={order?.product}>
                                        ...
                                        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                            ...
                                            <WrapperCountOrder>
                                                ...
                                                <WrapperInputNumber defaultValue={order?.amount} value={order?.amount} size="small" min={1} max={order?.countInStocks} />
                                                <button style={{ border: 'none', background: 'transparent', cursor: 'pointer' }} onClick={() => handleChangeCount('increase', order?.product, order?.amount === order.countInStocks)}>
